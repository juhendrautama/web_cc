						...
						<div class="row">
							<div class="col-lg">
								<div class="p-5">
									...
									<form class="user" method="post" action="autentikasi/ceklogin">
										<div class="form-group">
											<input type="text" required class="form-control form-control-user" id="email" name="username" placeholder="Masukkan Username .. ">
